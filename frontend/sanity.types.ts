...
// Query: *[_type == "settings"][0]{  ...,  navItems[]{    ...,      link {      ...,        _type == "link" => {    "page": page->slug.current,    "pageType": page->_type  }      },    children[]{      ...,        link {      ...,        _type == "link" => {    "page": page->slug.current,    "pageType": page->_type  }      }    }  },  ctaButton {    ...,      link {      ...,        _type == "link" => {    "page": page->slug.current,    "pageType": page->_type  }      }  },  footerColumns[]{    ...,    links[]{      ...,        link {      ...,        _type == "link" => {    "page": page->slug.current,    "pageType": page->_type  }      }    }  },  contactInfo,  locations[]{    ...,    logo  },  footerTagline,  footerText,  footerTextLink,  footerBottomLinks[]{    ...,      link {      ...,        _type == "link" => {    "page": page->slug.current,    "pageType": page->_type  }      }  },  logo,  yearEstablished,  socialLinks,  "faviconUrl": favicon.asset->url,  ga4MeasurementId,  gtmId,  ctmScriptUrl,  googleSiteVerification,  localBusiness}
